...
exports.commands = {
	...
	roompromote: function (target, room, user, connection, cmd) {
		...
		if (!user.can('makeroom')) {
			if (currentGroup !== ' ' && !user.can('room' + (Config.groups[currentGroup] ? Config.groups[currentGroup].id : 'voice'), null, room) && room.founder !== user.userid) {
			...
			if (nextGroup !== ' ' && !user.can('room' + Config.groups[nextGroup].id, null, room) && room.founder !== user.userid) {
